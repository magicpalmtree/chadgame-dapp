<template>
    <a 
        class="flex flex-row items-center font-bold text-secondary justify-center py-4 px-8 space-x-1 hover:text-secondary-light hover:cursor-pointer"
        href="https://t.me/CHADGAMEPORTAL"
        target="_blank"
    >
        <slot />
        <div class="px-2">
